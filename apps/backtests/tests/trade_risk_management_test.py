...
def sample_candles():
    ...
    return [{"high": 102 + i, "low": 98 + i, "close": 100 + i} for i in range(20)]
...
def test_relative_stop_loss_percentage(sample_candles):
    ...
    result = TradeRiskModel._calculate_relative_stop_loss_percentage(
        sample_candles, period=14, atr_multiplier=1.5
    )
