...
from market.services import get_binance_ohlcv
from strategies.services.core.trade_risk_model import TradeRiskModel
from .backtest.backtest_engine import BacktestEngine


def run_backtest(user, strategy: Strategy, initial_balance: float = 1000, token: str = 'BTC', timeframe: str = '1h', candle_amount: int = 500) -> dict:
    """
