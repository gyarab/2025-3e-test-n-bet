...
class BacktestEngine():
    ...
    def __init__(self, strategy: StrategyEngine, trade_risk_model: TradeRiskModel | None = None, candles: list[dict] | None = None, initial_balance: float = 1000, token: str = 'BTCUSDT', timeframe: str = '1h', candle_amount: int = 500):
