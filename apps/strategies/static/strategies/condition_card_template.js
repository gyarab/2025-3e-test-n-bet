            ...
            <div class="mt-3 grid grid-cols-2 gap-3">
                <div class="flex flex-col space-y-2 stop-loss-pair border border-gray-200 rounded px-3 py-2 bg-transparent shadow-sm">   
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="stop-loss-pct-${index}" class="w-full border border-gray-300 rounded px-2 py-1" placeholder="e.g. 2.5" default="2.5">
                    </div>
                </div>
                <div class="flex flex-col space-y-2 take-profit-pair border border-gray-200 rounded px-3 py-2 bg-transparent shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="take-profit-pct-${index}" class="w-full border border-gray-300 rounded px-2 py-1" placeholder="e.g. 5" default="5">
                    </div>
                </div>
                <div class="flex grid col-span-2 grid-cols-2 gap-10 position-size-pair border border-gray-200 rounded px-3 py-2 bg-transparent shadow-sm"> 
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" id="position-size-pct-${index}" class="w-full border border-gray-300 rounded px-2 py-1" placeholder="e.g. 1" default="1">
                    </div>
                </div>
            </div>
        </div>
