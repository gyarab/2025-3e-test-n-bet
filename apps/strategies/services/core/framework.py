...
def generate_strategy_rules_json(
    indicators: list[BaseIndicator], models: list[BaseModel]
) -> dict:
    ...
    rules = {
        "conditions": [
            {
                "indicators": {
                    type(i).__name__: i.get_json()[
                        type(i).__name__
                    ]  # name of each strategy class, e.g. SMAStrategy, RSIStrategy, etc.
                    for i in indicators
                },
                "models": {
                    type(i).__name__: i.get_json()[
                        type(i).__name__
                    ]  # name of each strategy class, e.g. ARIMA, etc.
                    for i in models
                },
